...
class StartAppCheckPermissions : AppCompatActivity()
{
    ...
    private fun drawView()
    {
        ...
        controllerThemeApp.setDesignButton(!themeApp, this.btn_getPermissions, R.drawable.style_get_permissions, 2)
        ...
        controllerThemeApp.setTextDesign(findViewById(R.id.mainText), resources.getString(R.string.hello_one),true)
    }
